...
<head>
    ...
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <meta charset="utf-8">
    <title><?php if($pageTitle) echo $pageTitle . ' | '; ?>Karnataka State Council for Science and Technology (KSCST)</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top wider">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <p class="navbar-text">Karnataka State Council for Science and Technology (KSCST)</p>
            </div>
