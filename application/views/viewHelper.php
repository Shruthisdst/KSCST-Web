...
class viewHelper extends View {
    ...
    public function displayCoverGalleryItem($data = array()) {
        ...
        <div class="cover-gallery-item">
            <a href="' . VOL_URL . implode('/', $data) . '" data-lightbox="Cover pages" data-title="Volume ' . $this->displayNumber($data[1]) . ', Issue ' . $this->displayNumber($data[2]) . '" title="Volume ' . $this->displayNumber($data[1]) . ', Issue ' . $this->displayNumber($data[2]) . '"><img src="' . VOL_URL . implode('/', $data) . '" alt="Cover page"></a>
        </div>
        ';
    }
